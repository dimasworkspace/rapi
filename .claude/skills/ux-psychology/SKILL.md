---
name: ux-psychology
description: Lensa psikologi perilaku buat keputusan desain UI/UX — 65 prinsip dari studi NN/g (atensi, Gestalt, memori, bias kognitif, persuasi, emosi, etika). Pakai SETELAH halaman/komponen/alur dibangun, sebagai lapisan review buat nemuin yang kelewat. Aktif saat mendesain atau meninjau landing page, onboarding, dashboard, checkout, alur langganan, navigasi, atau layar apa pun yang mau bikin user mengambil aksi tertentu. Bersifat masukan, bukan penentu — brand, aksesibilitas, dan kualitas teknis tetap menang di atasnya. Bukan buku dark pattern.
---
